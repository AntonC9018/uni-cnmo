...
cmake -S D:/Coding/C++/cnmo -B D:/Coding/C++/build/cnmo -GNinja "-DCMAKE_BUILD_TYPE:String=Debug" "-DQT_QMAKE_EXECUTABLE:STRING=D:/Qt/6.1.0/mingw81_64/bin/qmake.exe" "-DCMAKE_PREFIX_PATH:STRING=D:/Qt/6.1.0/mingw81_64" "-DCMAKE_C_COMPILER:STRING=D:/msys64/mingw64/bin/gcc.exe" "-DCMAKE_CXX_COMPILER:STRING=D:/msys64/mingw64/bin/g++.exe"
